...
<template>
  <div class="h-full flex flex-col scrollbarActive overflow-y-hidden">
    <div id="main" class="xxl:w-[1350px] xl:w-[1350px] lg:w-[1300px] mx-auto">
      ...
      <div class="w-full py-8 flex justify-between items-center">
        ...
        <div class="w-[70%] flex justify-end items-center">
          ...
          <div class="flex justify-end items-center w-[40%]">
            ...
            <div class="text-mWhite text-2xl flex justify-between items-center">
      ...
      <div class="w-full py-14 mt-14 flex justify-between items-center relative">
        <div class="flex flex-col w-1/2">
          <span class="text-mWhite text-[56px] font-semibold">{{$t('header.title_1')}}</span>
          <div>
            <span class="text-mRed text-[56px] font-semibold">{{$t('header.title_2')}} </span><span class="text-mWhite text-[56px] font-semibold">{{$t('header.title_3')}}</span>
          </div>
        </div>
        <div class="flex justify-end items-center pt-6 w-1/2">
          <div class="text-2Gray w-4/5 flex justify-end text-lg font-normal leading-6">{{$t('header.text')}}</div>
        </div>
        <div class="w-36 h-36 rounded-full bg-mRed absolute top-[80%] right-[50px] flex justify-center items-center text-mWhite text-base font-normal tracking-wider">{{$t('header.circle')}}</div>
      </div>
      <!-- Under Navbar End -->
    </div>
    <!-- Banner Image -->
    ...
    <!-- Banner Image -->
    <!-- Carausel Start -->
    <div id="service" class="xxl:w-[1350px] xl:w-[1350px] lg:w-[1300px] mx-auto mt-24">
      <!-- Header Start -->
      <div class="w-full flex justify-between">
        ...
        <div class="flex justify-end items-center w-1/2 text-2Gray">
          <div class="w-[60%] text-base font-normal ml-14">{{$t('carousel.text')}}</div>
        </div>  
      </div>
      <!-- Header End -->
      <!-- Body Start -->
    ...
    <!-- Carausel End -->
    <!-- Result Start -->
    <div id="advantages" class="xxl:w-[1350px] xl:w-[1350px] lg:w-[1300px] mx-auto my-24">
      <div class="w-[70%] mx-auto flex flex-col items-center">
        <div class="flex justify-end items-center w-full">
          <div class="w-[65%] flex justify-end mx-auto">
            <span class="text-mWhite text-[36px] tracking-wider">{{$t('underCarousel.title_1_1')}} </span> <span class="text-mRed text-[36px] tracking-wider ml-4"> {{$t('underCarousel.title_1_2')}}</span>
          </div>
        </div>
        <div class="flex justify-start items-center w-full">
          <div class="w-[65%] flex justify-start mx-auto">
            <span class="text-mWhite text-[36px] tracking-wider">{{$t('underCarousel.title_2_1')}} </span> <span class="text-mRed text-[36px] tracking-wider ml-4"> {{$t('underCarousel.title_2_2')}}</span>
          </div>
        </div>
      </div>
      <div class="w-full grid grid-cols-3 gap-14 mt-20">
        ...
        <div class="h-[300px] rounded-2xl">3</div>
        <div class="h-[300px] rounded-2xl">4</div>
        <div class="border border-2Gray h-[300px] rounded-2xl p-10">
          <div>
            <handGlobe/>            
          </div>
    ...
    <!-- Result End -->
    <!-- Counts Start -->
    <div id="about" class="xxl:w-[1350px] xl:w-[1350px] lg:w-[1300px] h-[700px] mx-auto mt-24 flex justify-between">
    ...
    <!-- Counts End -->
    <!-- Contact Start -->
    <div id="contacts" class="xxl:w-[1350px] xl:w-[1350px] lg:w-[1300px] mx-auto mt-24 flex flex-col">
    ...
    <div class="xxl:w-[1350px] xl:w-[1350px] lg:w-[1300px] mx-auto flex justify-between items-center text-mWhite opacity-20 my-4">
      <span>©2020-2023 RavoWorld. {{$t('contact.copy_right')}}</span>
